...
<div ui-view class="app-body" id="view">
    ...
    <div class="item">
        <div class="item-bg">
            <img src="{{ url('storage/uploads') . '/' . $user->foto }}" class="blur opacity-3">
        </div>
        <div class="p-a-md">
            <div class="row m-t">
                <div class="col-sm-7">
                    <a href class="pull-left m-r-md">
                        <span class="avatar w-96">
                            <img src="{{ url('storage/uploads') . '/' . $user->foto }}">
                    ...
                    <div class="clear m-b">
                        ...
                        <a href class="btn btn-sm warn btn-rounded m-b">{{ $user->isAdmin == 1 ? 'Admin' : 'Operator' }}</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-sm-6 push-sm-6">
                <div class="p-y text-center text-sm-right">
                    ...
                    <a href class="inline p-x text-center">
                        <span class="h4 block m-0">{{ $anggaran ? \FormatUang::format($anggaran) : 0 }}</span>
                    ...
                    <div class="tab-pane p-v-sm active" id="tab_4">
                        <div class="box">
                            <div class="box-header">
                                ...
                                <small>Silahkan dikosongi jika tidak ingin diupdate datanya.</small>
                            </div>
                                ...
                                <form action="{{ url('/profil/update') . '/' . $user->id }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="row row-sm mb-2">
                                        <div class="col-md-4 col-lg-4 col-xs-4">
                                            ...
                                            <input type="text" class="form-control" id="kode_skpd" name="kode_skpd" value="{{ $user->kode_SKPD }}" readonly>
                                        </div>
                                        <div class="col-md-4 col-lg-4 col-xs-4">
                                            <label for="nama_skpd">Nama SKPD</label>
                                            <input type="text" class="form-control" id="nama_skpd" name="nama_skpd" value="{{ $user->nama_SKPD }}">
                                        </div>
                                        <div class="col-md-4 col-lg-4 col-xs-4">
                                            <label for="nama_kpa">Nama KPA</label>
                                            <input type="text" class="form-control" id="nama_kpa" name="nama_kpa" value="{{ $user->nama_KPA }}">
                                        </div>
                                    </div>
                                    <div class="row row-sm mb-2">
                                        <div class="col-md-4 col-lg-4 col-xs-4">
                                            <label for="nama_operator">Nama Operator</label>
                                            <input type="text" class="form-control" id="nama_operator" name="nama_operator" value="{{ $user->nama_operator }}" placeholder="Nama Operator">
                                        </div>
                                        <div class="col-md-4 col-lg-4 col-xs-4">
                                            <label for="no_hp">Nomor Operator</label>
                                            <input type="text" class="form-control" id="no_hp" name="no_hp" value="{{ $user->no_hp }}" placeholder="No Hp">
                                        </div>
                                        <div class="col-md-4 col-lg-4 col-xs-4">
                                            <label for="no_kantor">Nomor Kantor</label>
                                            <input type="text" class="form-control" id="no_kantor" name="no_kantor" value="{{ $user->no_kantor }}" placeholder="No Kantor">
                                        </div>
                                    </div>
                                    ...
                                    <button type="submit" class="md-btn md-raised m-b-sm w-xs indigo" role="button">SIMPAN</button>
                                </form>
                            </div>
                        </div>
                    </div>
