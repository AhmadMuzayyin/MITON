                ...
                <div class="row">
                    <div class="col-sm-12 col-md-12">
                        <div class="box">
                            ...
                            <div class="box-body">
                                <a href="{{ route('user.create') }}" class="md-btn md-raised m-b-sm w-xs blue"
                                    role="button">Tambah</a>
                                <a href="{{ route('user.export') }}" class="md-btn md-raised m-b-sm w-xs blue"
                                        ...
                                        <tbody>
                                            @foreach ($data as $s)
                                                <tr>
                                                    ...
                                                    <td>{{ $s->nama_KPA }}</td>
                                                    <td>
                                                        <form action="{{ route('user.edit', $s->id) }}" method="GET"
                                                        ...
                                                        <form action="{{ route('user.destroy', $s->id) }}"
                                                            ...
                                                            @csrf
                                                            <button type="button"
                                                                class="md-btn md-raised m-b-sm red deleteUser" role="button"
                                                                style="border: 0px">
                ...
                <div class="row">
                    <div class="col-sm-12 col-md-12">
                        <div class="box">
                            ...
                            <div class="box-body">
                                <form id="addOPD" action="{{ route('user.store') }}" method="POST"
                                    ...
                                    <div class="row mb-3">
                                        <div class="col-md col-sm col-lg">
                                            ...
                                            <input type="text" class="form-control @error('kode') parsley-error @enderror"
                                                id="kode" name="kode" value="{{ old('kode') }}" placeholder="KODE SKPD">
                                        </div>
                                        <div class="col-md col-sm col-lg">
                                            <label for="skpd">NAMA SKPD</label>
                                            <input type="text" class="form-control @error('skpd') parsley-error @enderror"
                                                id="skpd" name="skpd" value="{{ old('skpd') }}" placeholder="NAMA SKPD">
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        <div class="col-md col-sm col-lg">
                                            ...
                                            <input type="text"
                                                class="form-control @error('nokantor') parsley-error @enderror"
                                                id="nokantor" name="nokantor" value="{{ old('nokantor') }}"
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md col-sm col-lg">
                                            ...
                                            <input type="password" class="form-control @error('password')  @enderror"
                                    ...
                                    <div class="row mb-3">
                                        <div class="col-md col-sm col-lg">
                                            ...
                                            <input type="text" class="form-control @error('kpa') parsley-error @enderror"
                                                id="kpa" name="kpa" value="{{ old('kpa') }}" placeholder="NAMA KPA">
                                        </div>
                                        <div class="col-md col-sm col-lg">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md col-sm col-lg mt-3">
                                            ...
                                            <button type="button" class="md-btn md-raised m-b-sm w-xs orange"
