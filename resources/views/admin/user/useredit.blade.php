                    ...
                    <form id="editOPD" action="{{ route('user.up') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row mb-3">
                            <div class="col-md col-sm col-lg">
                                ...
                                <input type="text" class="form-control" id="kode" name="kode" placeholder="KODE SKPD"
                                    value="{{ $d->kode_SKPD }}">
                            </div>
                            <div class="col-md col-sm col-lg">
                                <label for="skpd">NAMA SKPD</label>
                                <input type="text" class="form-control" id="skpd" name="skpd" placeholder="NAMA SKPD"
                                    value="{{ $d->nama_SKPD }}">
                            </div>
                        </div>
                        <div class="row mb-3">
                        ...
                        <div class="row mb-3">
                            <div class="col-md col-sm col-lg">
                                ...
                                <input type="text" class="form-control" id="kpa" name="kpa" placeholder="NAMA KPA"
                                    value="{{ $d->nama_KPA }}">
                            </div>
                            <div class="col-md col-sm col-lg">
